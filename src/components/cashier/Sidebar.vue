...
const dropdownMenus = ref([
  { name: 'Point Of Sale',
    ...
    isOpen:false,
    subItems: [
      { name: 'Point Of Sale', path: '/cashier/point-of-sale/point-of-sale',  icon: BuildingStorefrontIcon },
      { name: 'Sales History', path: '/cashier/point-of-sale/sales-history', icon: ClipboardDocumentListIcon },
    ]
  ...
  },
  {
    ...
    isOpen: false,
    subItems: [
      { name: 'Pickup in Store', path: '/cashier/reservation/pickup', icon: ShoppingBagIcon },
      { name: 'Delivery', path: '/cashier/reservation/delivery', icon: TruckIcon },
    ]
  },
])
