<!-- components/landing/Carousel.vue -->
<template>
      ...
      >
        ...
        <div class="absolute inset-0 flex items-center bg-black/40">
          <div class="max-w-[600px] ml-[10%]">
            ...
            <button 
              @click="goToHome"
              class="bg-[#FF9934] hover:bg-[#FF8000] text-white px-8 py-3 rounded-full text-base font-semibold uppercase transition-colors duration-300"
            >
              {{ slide.buttonText }}
            </button>
          </div>
