<!-- layouts/StockManagerLayout.vue -->
<template>
  ...
  import StockManagerHeader from '@/components/stockManager/Header.vue'
  import StockManagerSidebar from '@/components/stockManager/Sidebar.vue'
  import PageHeader from '@/components/common/PageHeader.vue'
  
  const route = useRoute()
  const isSidebarOpen = ref(false)
  const isSidebarActive = ref(false)
  const isStockManagerDropdownOpen = ref(false)
  ...
  const openStockManagerDropdown = () => {
    isStockManagerDropdownOpen.value = true
    isSidebarOpen.value = true // Ensure sidebar is open
  }
  
  provide('openStockManagerDropdown', openStockManagerDropdown)
  provide('isStockManagerDropdownOpen', isStockManagerDropdownOpen)
  </script>
